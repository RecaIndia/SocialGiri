...
namespace WoWonder.Activities.NativePost.Extra
{
    ...
    public class YoutubePlayerActivity : AppCompatActivity, IYouTubePlayerOnInitializedListener, StTools.IXAutoLinkOnClickListener, View.IOnClickListener, View.IOnLongClickListener
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            try
            {
                ...
                PostClickListener = new PostClickListener(this);
            ...
            { 
                ...
                if (PostObject != null)
                {
                    ...
                    if (publisher != null)
                    {
                        ...
                        TimeText.Text = success ? Methods.Time.TimeAgo(number) : PostObject.Time;
                    ...
                    if (AppSettings.PostButton == PostButtonSystem.ReactionDefault || AppSettings.PostButton == PostButtonSystem.ReactionSubShine)
                    {
                        ...
                        if ((bool)(PostObject.Reaction != null & PostObject.Reaction?.IsReacted))
                        {
                            if (!string.IsNullOrEmpty(PostObject.Reaction.Type))
                            {
                                switch (PostObject.Reaction.Type)
                                {
                                    case "1":
                                    case "Like":
                    ...
                    else
                    {
                        ...
                        if (LikeCount != null)
                            LikeCount.Text = Methods.FunString.FormatPriceValue(int.Parse(PostObject.PostLikes)) + " " + GetString(Resource.String.Btn_Likes);
