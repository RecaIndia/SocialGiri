...
namespace WoWonder.Activities.MyProfile
{
    ...
    public class EditMyProfileActivity : AppCompatActivity, MaterialDialog.IListCallback, MaterialDialog.ISingleButtonCallback
    {
        ...
        protected override void OnActivityResult(int requestCode, Result resultCode, Intent data)
        {
            try
            {
                ...
                if (requestCode == 503 && resultCode == Result.Ok) GetPlaceFromPicker(data);
            }
            catch (Exception e)
            {
                Console.WriteLine(e);
