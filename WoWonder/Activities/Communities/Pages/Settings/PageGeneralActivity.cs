...
namespace WoWonder.Activities.Communities.Pages.Settings
{
    ...
    public class PageGeneralActivity : AppCompatActivity, MaterialDialog.IListCallback, MaterialDialog.ISingleButtonCallback
    {
        ...
        public void OnSelection(MaterialDialog p0, View p1, int itemId, ICharSequence itemString)
        {
            try
            {
                ...
                else if (DialogType == "SubCategories")
                {
