...
namespace WoWonder.Activities.Communities.Groups.Settings
{
    ...
    public class GroupGeneralActivity : AppCompatActivity, MaterialDialog.IListCallback, MaterialDialog.ISingleButtonCallback
    {
        ...
        public void OnSelection(MaterialDialog p0, View p1, int itemId, ICharSequence itemString)
        {
            try
            {
                ...
                else if (TypeDialog == "SubCategories")
                {
