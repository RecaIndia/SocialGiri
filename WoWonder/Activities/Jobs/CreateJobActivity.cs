...
namespace WoWonder.Activities.Jobs
{
    ...
    public class CreateJobActivity : AppCompatActivity, MaterialDialog.IListCallback, MaterialDialog.ISingleButtonCallback
    { 
        ...
        protected override void OnActivityResult(int requestCode, Result resultCode, Intent data)
        {
            try
            {
                ...
                else if (requestCode == 502 && resultCode == Result.Ok)
